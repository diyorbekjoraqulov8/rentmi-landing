...
// Payment providers — brand logos in public/landing/ (74×36 PNGs).
const payments = [
  { name: 'Uzum', src: '/landing/uzum.png' },
  { name: 'Click', src: '/landing/click.png' },
  { name: 'Payme', src: '/landing/payme.png' },
  { name: 'Atmos', src: '/landing/atmos.png' }
]
