...
<template>
  <div class="relative pt-4 sm:pt-0">
    <!-- Settings menu -->
    <div
      class="w-full max-w-[300px] overflow-hidden rounded-2xl bg-surface shadow-card sm:mt-28">
      <ul class="divide-y divide-neutral-100">
        <li
          ...
          <span :class="m.tint">
            <component :is="m.comp" class="size-4.5" />
          </span>
          <span
          ...
          >
          <span v-if="m.badge" class="text-xs text-neutral-400">{{
            m.badge
          }}</span>
          <Icon
            v-if="m.chevron"
    ...
    <div
      ...
      <div class="flex flex-col items-center text-center">
        ...
        <p class="mt-2 font-bold text-neutral-900">Murod Talipov</p>
        <p class="text-xs text-neutral-400">+998 93 484 70 50</p>
      </div>

      <!-- Completion -->
      <p class="mt-4 text-[11px] text-neutral-500">
        Profil
        <span class="font-semibold text-neutral-900">{{ completion }}%</span>
        {{ t('landing.features.tpanels.profile.filled') }}
      </p>
