...
// 6 of 8 months paid → progress segments
const paid = 6
const total = 8
</script>

<template>
  <div class="overflow-hidden rounded-2xl bg-surface shadow-card w-full">
    <!-- Cover -->
    ...
    <div class="p-4 space-y-3">
      ...
      <!-- Dates -->
      <dl class="space-y-1.5 border-t border-neutral-100 pt-3 text-xs">
